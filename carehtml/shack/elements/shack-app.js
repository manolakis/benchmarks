...
import {css, html as litHtml, LitElement} from 'lit-element';
import {wrap} from './auto-define/index.js';

// const css = wrap(litCss);
  ...
  render() {
    return html`
      <header id="pageHeader">
        <h1 id="logo">SHACK</h1>
        <${ShackCart} .items=${this.cart}></${ShackCart}>
